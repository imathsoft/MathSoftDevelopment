...
class ProblemAbstract
{
	...
	std::function<T(const T&, const T&, const T&)> GetACoeff()
	{
	...
	std::function<std::array<T, 3>(const T&, const T&, const T&)> GetACoeffGradient()
	{
		return [=](const T& derivative, const T& value, const T& argument ) 
		{
	...
	std::function<T(const T&, const T&, const T&)> GetBCoeff()
	{
		return [=](const T& derivative, const T& value, const T& argument ) 
		{ return Nonlin(value); };
	}
	...
	std::function<std::array<T, 3>(const T&, const T&, const T&)> GetBCoeffGradient()
	{
		return [=](const T& derivative, const T& value, const T& argument ) 
		{
			std::array<T, 3> result;
	...
	std::function<T(const T&, const T&, const T&)> GetACoeffInverse()
	{
		return [=](const T& derivative, const T& value, const T& argument ) 
		{
			T N = Nonlin(argument);
	...
	std::function<std::array<T, 3>(const T&, const T&, const T&)> GetACoeffInverseGradient()
	{
		return [=](const T& derivative, const T& value, const T& argument ) 
		{
			std::array<T, 3> result;
	...
	std::function<T(const T&, const T&, const T&)> GetBCoeffInverse()
	{
		return [=](const T& derivative, const T& value, const T& argument )			
		{
	...
	std::function<std::array<T, 3>(const T&, const T&, const T&)> GetBCoeffInverseGradient()
	{
		return [=](const T& derivative, const T& value, const T& argument ) 
		{
			std::array<T, 3> result;
