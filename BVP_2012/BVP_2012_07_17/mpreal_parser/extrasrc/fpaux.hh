...
#ifdef FP_SUPPORT_MPFR_FLOAT_TYPE
    template<>
    inline mpreal fp_const_pi<mpreal>() { return "4"*atan(mpreal("1")); }

    template<>
    inline mpreal fp_const_e<mpreal>() { return exp(mpreal("1")); }

    template<>
    inline mpreal fp_const_einv<mpreal>() { return exp(mpreal("-1")); }

    template<>
    inline mpreal fp_const_log2<mpreal>() { return const_log2(); }

    /*
    template<>
    inline mpreal fp_const_log10<mpreal>() { return fp_log(mpreal(10)); }

    template<>
    inline mpreal fp_const_log2inv<mpreal>() { return mpreal(1) / mpreal::const_log2(); }

    template<>
    inline mpreal fp_const_log10inv<mpreal>() { return fp_log10(mpreal::const_e()); }
    */
#endif
...
// -------------------------------------------------------------------------
#ifdef FP_SUPPORT_MPFR_FLOAT_TYPE
    inline mpreal fp_abs(const mpreal& x) { return abs(x); }
	inline mpreal fp_acos(const mpreal& x) { return acos(x); }
    inline mpreal fp_acosh(const mpreal& x) { return acosh(x); }
    inline mpreal fp_asin(const mpreal& x) { return asin(x); }
    inline mpreal fp_asinh(const mpreal& x) { return asinh(x); }
    inline mpreal fp_atan(const mpreal& x) { return atan(x); }
    inline mpreal fp_atan2(const mpreal& x, const mpreal& y)
    { return atan2(x, y); }
    inline mpreal fp_atanh(const mpreal& x) { return atanh(x); }
    inline mpreal fp_cbrt(const mpreal& x) { return cbrt(x); }
    inline mpreal fp_ceil(const mpreal& x) { return ceil(x); }
    inline mpreal fp_cos(const mpreal& x) { return cos(x); }
    inline mpreal fp_cosh(const mpreal& x) { return cosh(x); }
    inline mpreal fp_exp(const mpreal& x) { return exp(x); }
    inline mpreal fp_exp2(const mpreal& x) { return exp2(x); }
    inline mpreal fp_floor(const mpreal& x) { return floor(x); }
    inline mpreal fp_hypot(const mpreal& x, const mpreal& y)
    { return hypot(x, y); }
    inline mpreal fp_int(const mpreal& x) { return round(x); }
    inline mpreal fp_log(const mpreal& x) { return log(x); }
    inline mpreal fp_log2(const mpreal& x) { return log2(x); }
    inline mpreal fp_log10(const mpreal& x) { return log10(x); }
    inline mpreal fp_mod(const mpreal& x, const mpreal& y) { return fmod(x, y); }
    inline mpreal fp_sin(const mpreal& x) { return sin(x); }
    inline mpreal fp_sinh(const mpreal& x) { return sinh(x); }
	inline mpreal fp_sqrt(const mpreal& x) { return sqrt(x); }
    inline mpreal fp_tan(const mpreal& x) { return tan(x); }
    inline mpreal fp_tanh(const mpreal& x) { return tanh(x); }
    inline mpreal fp_trunc(const mpreal& x) { return trunc(x); }

    inline mpreal fp_pow(const mpreal& x, const mpreal& y) { return pow(x, y); }
    inline mpreal fp_pow_base(const mpreal& x, const mpreal& y) { return pow(x, y); }


    inline void fp_sinCos(mpreal& sin, mpreal& cos, const mpreal& a)
    {
        sin_cos(sin, cos, a);
    }

    inline void fp_sinhCosh(mpreal& sinhvalue, mpreal& coshvalue,
                            const mpreal& param)
    {
        const mpreal paramCopy = param;
        sinhvalue = fp_sinh(paramCopy);
        coshvalue = fp_cosh(paramCopy);
    }

    template<>
    inline mpreal fp_epsilon<mpreal>() { return machine_epsilon(); }
...
#ifdef FP_SUPPORT_MPFR_FLOAT_TYPE
    template<>
    inline bool isInteger(const mpreal& value) { return _isint(value); }

    template<>
    inline bool isEvenInteger(const mpreal& value)
    {
        return _isint(value) && fmod(value,"2") == 0;
    }

    template<>
    inline long makeLongInteger(const mpreal& value)
    {
...
#ifdef FP_SUPPORT_MPFR_FLOAT_TYPE
    template<>
    inline bool isOddInteger(const mpreal& value)
    {
        return _isint(value) && fmod(value, "2") != 0;
    }
#endif
...
#ifdef FP_SUPPORT_MPFR_FLOAT_TYPE
# define FUNCTIONPARSER_INSTANTIATE_MF(g) g(mpreal)
#else
